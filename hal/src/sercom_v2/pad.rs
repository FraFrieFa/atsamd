...
/// Type-level function mapping each [`PinId`] to the list of possible SERCOM
/// order indices it can serve.
pub trait PinSercoms: PinId {
    type Sercoms: HList;
}
...
mod ioset {
    ...
    ///
    /// [`spi::Pads`]: crate::sercom_v2::spi::Pads
    /// [`uart::Pads`]: crate::sercom_v2::uart::Pads
    /// [`i2c::Pads`]: crate::sercom_v2::i2c::Pads
    /// [type-level enum]: crate::typelevel#type-level-enum
