...
struct Pads<P0: OptionalPad, P1: OptionalPad, P2: OptionalPad, P3: OptionalPad>(P0, P1, P2, P3);
...
trait ReplacePad<P: PadNum> : IsPads
{
    fn replace<I: IsPad<PadNum = P>>(self, pin: I) -> impl IsPads;
}

impl<P1: OptionalPad, P2: OptionalPad, P3: OptionalPad> ReplacePad<Pad0>
    for Pads<NoneT, P1, P2, P3>
{
    fn replace<I: IsPad<PadNum = Pad0>>(self, pin: I) -> impl IsPads {
...
{
    fn replace<I: IsPad<PadNum = Pad1>>(self, pin: I) -> impl IsPads {
...
{
    fn replace<I: IsPad<PadNum = Pad2>>(self, pin: I) -> impl IsPads {
...
{
    fn replace<I: IsPad<PadNum = Pad3>>(self, pin: I) -> impl IsPads {
...
mod ioset {
    ...
    use super::*;
    use crate::mk_hlist;
    use crate::typelevel::{HList, Intersection, NonEmptyHList};
    ...
    {
        type IoSets = <P0::SetList as Intersection<P1::SetList>>::Output;
    }
    ...
    where
        ...
        <<P0::SetList as Intersection<P1::SetList>>::Output as Intersection<P2::SetList>>::Output:
            Intersection<P3::SetList>,
    {
        type IoSets = <<<P0::SetList as Intersection<P1::SetList>>::Output as Intersection<
            P2::SetList,
        >>::Output as Intersection<P3::SetList>>::Output;
    }
