...
use typenum::{Add1, Bit, Sub1, UInt, Unsigned, B1, U0, Cmp, Equal, Less, Greater};
...
/// Macro to build a type-level list (HList) from a comma-separated list of types.
///
/// # Examples
///
/// ```rust
...
///
/// This trait is implemented for typenum's ordering results that are either equal or less.
pub trait LeOrEq {}
...
/// Skip the right head and intersect the entire left list with the tail of the right list.
impl<HA, TA, HB, TB: HList> IntersectionCaseTrait
